...
ALLOWED_HOSTS = tuple(get_env_variable("ALLOWED_HOSTS", "").split(" "))
...
PROJECT_DIRNAME = "djangotemplate"
...
WSGI_APPLICATION = "djangotemplate.config.wsgi.application"

TEMPLATES = [
    {
        "BACKEND": "django.template.backends.django.DjangoTemplates",
        "DIRS": [os.path.join(BASE_DIR, "djangotemplate", "templates")],
        "OPTIONS": {
            "context_processors": [
...
INSTALLED_APPS = (
    "djangotemplate.core.apps.CoreConfig",
    "djangotemplate.accounts.apps.AccountsConfig",
    "django.contrib.auth",
